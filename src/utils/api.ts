...
//     FIXED
    GET_FIXEDS: `http://localhost:3001/fixed`,
    ADD_FIXED: `http://localhost:3001/fixed`,
    GET_FIXED: (date: string) => `http://localhost:3001/fixed/day?date=${date}`,
    EDIT_FIXED: (date: string) => `http://localhost:3001/fixed/day?date=${date}`,
    DELETE_FIXED: (date: string) => `http://localhost:3001/fixed/day?date=${date}`,
//     FLEXI
    GET_FLEXIS: `http://localhost:3001/flexi`,
    ADD_FLEXI: `http://localhost:3001/flexi`,
    GET_FLEXI: (date: string) => `http://localhost:3001/flexi/day?date=${date}`,
    EDIT_FLEXI: (date: string) => `http://localhost:3001/flexi/day?date=${date}`,
    DELETE_FLEXI: (date: string) => `http://localhost:3001/flexi/day?date=${date}`,
//     EXCLUSIONS
