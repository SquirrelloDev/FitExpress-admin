...
function Reports() {
	...
	return (
		<>
			...
			{modalOpen.isOpen && modalOpen.modalType === ModalType.details && <Modal><ReportDetails id={itemId} token={userData.token} closeModal={setModalOpen} /></Modal>}
			{modalOpen.isOpen && modalOpen.modalType === ModalType.delete && <Modal><ViewDelete id={itemId} closeModal={setModalOpen} deleteMutation={deleteReport}/></Modal>}
		</>
	)
}
